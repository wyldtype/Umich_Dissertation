...
%%%%%%%%%%%%%%%%%%%%%% ANNA %%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% If you get Error: File ended while scanning use of \@@BOOKMARK, delete the main.out file!
...
\acronyms{
    ...
    \acro{Scer}{\textit{Saccharomyces cerevisiae}}
    \acro{Spar}{\textit{Saccharomyces paradoxus}}
    \acro{Hyb}{\textit{Saccharomyces cerevisiae} x \textit{Saccharomyces paradoxus} F1 hybrid}
    \acro{Hyc}{F1 hybrid, \textit{S. cerevisiae} allele}
    \acro{Hyp}{F1 hybrid, \textit{S. paradoxus} allele}
}
...
% My attempt to add S in front of supplemental figure numbers
\DeclareCaptionLabelFormat{withS}{#1 S#2}
...
\input{chapters/chapter_plasticity}
\input{chapters/chapter_networks}
\input{chapters/chapter_misexpression}
% Place your additional chapters here using the \input{} command
\input{chapters/conclusion}

% Appendices
\appendix
%\input{appendices/appendix_NetworksGOtables}
\input{appendices/appendix_F2ChromMaps}
